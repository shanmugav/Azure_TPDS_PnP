...
#define IOT_PLUG_AND_PLAY_MODEL_ID "dtmi:com:Microchip:CryptoAuthTrustPlatform_HR9;1" ////dtmi:microchip:CryptoAuthTrustPlatform_HR9;1" 
//"dtmi:microchip:CryptoAuthTrustPlatform_HR9;1"
